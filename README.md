...
| Vista | Qué muestra |
|-------|-------------|
| **Dashboard** | Funnel y alertas, métricas agregadas del IDE por engine, convicción media, riesgo de cartera (concentración/correlación proxy, HHI, P/L) y últimas señales sistemáticas |
